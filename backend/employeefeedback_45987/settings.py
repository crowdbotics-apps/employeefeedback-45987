"""
Django settings for employeefeedback_45987 project.
...
ROOT_URLCONF = 'employeefeedback_45987.urls'
...
WSGI_APPLICATION = 'employeefeedback_45987.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "employeefeedback_45987 API",
    "DESCRIPTION": "API documentation for employeefeedback_45987 App",
    "VERSION": "v1",
}
